<template>
    <div>
        ...
        <el-button type="primary" round size="small" @click="search('未支付')">搜索</el-button>
        <el-table :data="orderAry" style="width: 100%" :default-sort="{prop: 'serviceTime', order: 'descending'}">
