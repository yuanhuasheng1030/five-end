<template>
  <div>
      <el-button type="primary" @click="dialogFromVisible=true" plain>增加宠物主人</el-button>
      <el-dialog title="增加宠物主人信息" :visible.sync="dialogFromVisible">
      <el-form>
        ...
        <el-form-item label="区 域" :label-width="formLabelWidth">
